    ...
    function(input, output) 
    {
        ...
        output$RiskLevel <- renderPrint({
            if(input$RiskButton > 0)
            {
                ...
                if(risk <= 10) print('LOW RISK', quote = F)
                else if(risk >= 11 & risk < 20) print('INTERMEDIATE RISK', quote = F)
                else if(risk >= 20) print('HIGH RISK', quote = F)
